...
% Read in the image
img = imread('do_not_enter_test.jpg');
...
dlmwrite('do_not_enter_test_red.txt', red, ' ');
dlmwrite('do_not_enter_test_green.txt', green, ' ');
dlmwrite('do_not_enter_test_blue.txt', blue, ' ');